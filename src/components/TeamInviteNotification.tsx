      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-lg font-bold">{teamInfo?.name || 'Loading...'}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-muted-foreground">Invited by:</span>
            <span className="text-sm">{inviterInfo?.full_name || 'Loading...'}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-muted-foreground">Status:</span>
            <Badge variant={teamInfo?.is_finalized ? "default" : "secondary"}>
          ...
          {teamInfo?.room && teamInfo.room !== 'TBD' && (
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm">{teamInfo.room}</span>
            </div>
          )}
        </div>
